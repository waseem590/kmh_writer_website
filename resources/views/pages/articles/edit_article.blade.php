                        ...
                        <div class="card latest-update-card">
                            ...
                            <div class="card-block">
                                <div class="card-header-right">
                                    <form method="POST" action="{{route('update.article')}}" id="add_article" enctype="multipart/form-data">
                                        @csrf
                                        <input type="hidden" name="id" value="{{$article->id}}">
                                        <div class="form-group bmd-form-group">
                                            <label class="bmd-label-static">Heading</label>
                                            <input required type="text" name="heading" class="form-control right-hand-side" placeholder="تحریر کریں" dir="rtl" value="{{$article->heading}}">
                                        </div>
                                        <div class="form-group bmd-form-group">
                                            <label class="bmd-label-static">Sub Heading</label>
                                            <input required type="text" class="form-control right-hand-side" dir="rtl" placeholder="تحریر کریں" name="sub_heading" value="{{$article->sub_heading}}">
                                        </div>
                                        <div class="form-group bmd-form-group">
                                        ...
                                        <div class="form-group bmd-form-group">
                                            ...
                                            <input type="file" class="form-control" name="letter_image" required>
                                        </div>
                                        <div class="form-group bmd-form-group">
                                        ...
                                        <div class="form-group bmd-form-group">
                                            ...
                                            <textarea name="description" id="description" class="right-hand-side form-control" placeholder="تحریر کریں">{{$article->description}}</textarea>
                                        </div>
                                        <div class="form-group bmd-form-group">
                                            <button type="button" class="btn btn-primary" id="save_article">Update Article</button>
                                        </div>
                                    </form>
